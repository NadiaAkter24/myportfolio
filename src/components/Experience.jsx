...
function Experience() {
  ...
  const otherExperiences = [
    ...
    },
    {
      ...
      responsibilities: ["Delivered one-on-one tutoring in Physics, Chemistry, and Mathematics"]
    }
  ];
            ...
            {exp.roles &&
              exp.roles.map((role, i) => (
                <div key={i} className="mt-4">
                  <h5 className="text-xl font-semibold">{role.role}</h5>
